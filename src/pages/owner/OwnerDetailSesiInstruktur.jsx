...
export default function OwnerDetailSesiInstruktur() {
    ...
    <>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="px-4 md:px-8 pl-14 md:pl-8 py-4 flex justify-between items-center border-b border-[#e9e9e7] bg-white sticky top-0 z-10">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-[#37352f]/60 cursor-pointer hover:text-[#0b6e99]" onClick={() => navigate('/owner/siswa')}>Manajemen Siswa</span>
      ...
      <div className="hidden print:block w-full text-[#37352f] font-sans p-8 bg-white min-h-screen relative">
        ...
        <div className="flex items-center justify-between border-b-2 border-[#37352f] pb-4 mb-6">
          ...
          <div className="text-right">
            <h1 className="text-xl font-bold text-[#0b6e99] leading-none mb-1">LAPORAN LOG MENGAJAR</h1>
            <p className="text-[10px] font-bold text-[#37352f]/50 uppercase tracking-widest font-mono">DOKUMEN RIWAYAT PENGAJARAN</p>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6 bg-[#efefed]/25 p-4 rounded-xl border border-[#e9e9e7]">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex">
              <span className="w-40 font-medium text-[#37352f]/60">Periode Laporan</span>
              <span className="font-bold text-[#0b6e99]">: {selectedBulan}</span>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              <span className="w-40 font-medium text-[#37352f]/60">Sesi Selesai (Diajar)</span>
        ...
        <table className="w-full text-left border-collapse mb-8 text-sm">
          <thead>
            <tr className="bg-[#fbfbfa] border-b border-[#e9e9e7]">
              ...
              <th className="p-3 border border-[#e9e9e7] font-bold text-xs uppercase tracking-wider text-[#37352f]/60 text-center w-24">Pertemuan Ke</th>
              ...
              <th className="p-3 border border-[#e9e9e7] font-bold text-xs uppercase tracking-wider text-[#37352f]/60 text-center w-48">Tanggal & Waktu</th>
          ...
          <tbody>
            {displayedSesiList.map((sesi, index) => (
              <tr key={sesi.id} className="border-b border-[#e9e9e7]">
                <td className="p-3 border border-[#e9e9e7] text-center font-semibold">{index + 1}</td>
            ...
            {displayedSesiList.length === 0 && (
              <tr>
                <td colSpan="6" className="p-8 text-center text-[#37352f]/40 font-medium italic">Tidak ada data sesi untuk periode ini.</td>
              </tr>
            )}
          </tbody>
        </table>
        ...
        <div className="flex justify-end mt-12 text-center">
          <div>
            ...
            <p className="text-xs text-[#37352f]/60 font-bold uppercase tracking-wider">Owner</p>
          </div>
        </div>
